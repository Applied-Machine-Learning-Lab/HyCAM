...
def get_raw_dataset(dataset_name, output_path, seed, local_rank, select_num):
    print('Getting Raw Dataset')
    ...
    if "Dahoas/rm-static" in dataset_name:
        ...
        return raw_datasets.LmqgQagjaquadDataset(output_path, seed, local_rank,
                                                 dataset_name)
    elif 'Alpaca-CoT' in dataset_name or 'Alpaca_CoT' in dataset_name:
        return raw_datasets.AlpacaCotDataset(output_path, seed, local_rank,
                                                 dataset_name, select_num)
...
def create_dataset(local_rank, dataset_name, data_split, output_path,
                   ...
                   max_seq_len, rebuild, select_num):
    raw_dataset = get_raw_dataset(dataset_name, output_path, seed, local_rank, select_num=select_num)
...
def create_prompt_dataset(local_rank,
    ...
    if select_num and select_num < 500:
        print('Single Data Only, select_num', select_num)
    ...
    if local_rank <= 0 and (buf_create_cache.item() != 0 or reload):
        ...
        if len(data_path) == 1:  # Single dataset.
            train_dataset, eval_dataset = create_dataset(
                ...
                end_of_conversation_token,
                max_seq_len,
                rebuild=reload, select_num=select_num)
